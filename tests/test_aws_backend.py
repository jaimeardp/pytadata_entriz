...
# from mardata_entryana.providers import aws as backend # Assuming this is your module
...
def test_aws_write_roundtrip(tmp_path):
    ...
    with mock_aws(): # Changed this line
        ...
        s3_client = boto3.client("s3", region_name="us-east-1") # Or your preferred region
        ...
        backend.write(df, dest="s3://bucket-name/x/", mode="overwrite",
                      partition_cols=None, dtype=None)